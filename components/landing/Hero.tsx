    ...
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            Land your dream job faster with AI that builds resumes, crafts cover
            letters, preps you for interviews, and maps your entire career
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#0a0f1e]/80 shadow-2xl backdrop-blur-sm">
            ...
            <div className="grid gap-4 p-6 sm:grid-cols-3">
              {[
                { label: "Resume Score", value: "94/100", color: "text-emerald-400" },
                { label: "Job Matches", value: "47", color: "text-violet-400" },
                { label: "Interview Ready", value: "87%", color: "text-cyan-400" },
              ].map((stat) => (
                <div
                  key={stat.label}
            ...
            <div className="border-t border-white/5 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-zinc-400">Career roadmap: 75% complete</span>
              </div>
            </div>
          </div>
        </motion.div>
