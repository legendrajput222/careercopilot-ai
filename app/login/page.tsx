...
return
  <div className="min-h-screen flex items-center justify-center bg-black"> <div className="w-full max-w-md bg-zinc-900 p-8 rounded-2xl shadow-xl transition-all duration-300 hover:shadow-purple-500/20">
